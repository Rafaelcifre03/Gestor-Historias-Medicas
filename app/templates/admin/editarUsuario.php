    ...
    <div class="container-fluid pe-sm-5 ps-sm-5 mt-3">
        ...
        <div class="row radio10 border text-white p-2">
            <div class="align-middle p-2">
                <h1 class="fs-1 text-center"><b>Editar Usuario</b></h1>
            </div>
        </div>
            ...
            <div class="col-12">
                ...
                <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                    ...
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        ...
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="text" name="apellido1" class=" form-control" value="<?php echo $datos['primer_apellido'] ?>">
                        </div>
                    </div>
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        <p class="col-12 col-md-5 col-lg-2 align-middle m-0 ms-sm-3 ">Segundo apellido: </p>
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="text" name="apellido2" class=" form-control" value="<?php echo $datos['segundo_apellido'] ?>">
                        </div>
                    </div>
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                    ...
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        ...
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="date" name="borndate" class="form-control" value="<?php echo $datos['fecha_nacimiento'] ?>">
                        </div>
                    </div>
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        <p class="ms-sm-3 col-12 col-md-5 col-lg-2 align-middle m-0">Direccion: </p>
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="text" name="direction" class=" form-control" value="<?php echo $datos['direccion'] ?>">
                        </div>
                    </div>
                    ...
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        ...
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="text" name="dni" class=" form-control" value="<?php echo $datos['dni'] ?>">
                        </div>
                    </div>
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        <p class="ms-sm-3 col-12 col-md-5 col-lg-2 align-middle m-0">Usuario: </p>
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="text" name="usuario" class=" form-control" value="<?php echo $datos['user_name'] ?>">
                        </div>
                    </div>
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        <p class="ms-sm-3 col-12 col-md-5 col-lg-2 align-middle m-0">Contraseña: </p>
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="text" name="contrasena" class=" form-control" value="<?php echo $datos['contrasena'] ?>">
                        </div>
                    </div>
                    <div class="d-flex mb-2 mt-2 flex-column flex-md-row">
                        <p class="ms-sm-3 col-12 col-md-5 col-lg-2 align-middle m-0">Rol: </p>
                        <div class="col-12 col-md-7 col-lg-10">
                            <input type="text" name="rol" class=" form-control" value="<?php echo $datos['tipo_usuario'] ?>">
                        </div>
                    </div>
                    <div class="ms-sm-5 me-sm-5 mb-5 p-3 text-end">
                        <button type="button" class="btn btn-secondary">Reset</button>
                        <button type="submit" name="editar_paciente" class="btn btn-success">Editar Usuario</button>
                    </div>
                </form>
